...
public final class MaidConstants {
    ...
    public static final String MAID_GRADLE = "littlemaid loom";
    ...
    public static class Dependencies{
        ...
        public static String getLittleMaidModelLoader(Project project){
            final LittleMaidLoomExtension littleMaidLoomExtension = project.getExtensions().getByType(LittleMaidLoomExtension.class);
            String minecraftVersion = littleMaidLoomExtension.getMinecraftVersion().get();
            String lmmlVersion = littleMaidLoomExtension.getLittleMaidModelLoaderVersion().get();
        ...
        public static String getLittleMaidReBirth(Project project){
            final LittleMaidLoomExtension littleMaidLoomExtension = project.getExtensions().getByType(LittleMaidLoomExtension.class);
            String minecraftVersion = littleMaidLoomExtension.getMinecraftVersion().get();
            String lmrbVersion = littleMaidLoomExtension.getLittleMaidReBirthVersion().get();
