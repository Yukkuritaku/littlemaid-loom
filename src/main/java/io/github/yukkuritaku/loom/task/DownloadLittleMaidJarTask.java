...
""", e);
    ...
    private enum LittleMaidJarType{
        ...
        private final BiFunction<String, LittleMaidLoomExtension, Path> toPathFunction;

        LittleMaidJarType(BiFunction<String, LittleMaidLoomExtension, Path> toPathFunction){
            this.toPathFunction = toPathFunction;
        }

        public Path toPath(String fileName, LittleMaidLoomExtension extension){
