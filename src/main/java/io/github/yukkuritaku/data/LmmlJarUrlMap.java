            ...
            Map.ofEntries(
                    ...
                    e("1.16.5",
                            Map.ofEntries(
                                    ...
                                    e("2.0.9", JarMetadata.create("https://www.dropbox.com/sh/tzkdz46y67tuohx/AAD0yDcdyXWRWrNhKK0Eaws3a/LittleMaidModelLoader/Fabric/1.16.x/old/LMML-Fa-Arc-1.16.5-2.0.9.jar")),
                                    e("2.1.0", JarMetadata.create(
                                    ...
                                    e("2.6.2", JarMetadata.create("https://www.dropbox.com/sh/tzkdz46y67tuohx/AADdi1_AagulWCJMgdVw06hwa/LittleMaidModelLoader/Fabric/1.16.x/old/LMML-1.16.5-2.6.2-Fabric.jar")),
                                    e("2.6.3", JarMetadata.create("https://www.dropbox.com/sh/tzkdz46y67tuohx/AAAqxxGllDFr89krb3XD1Mqaa/LittleMaidModelLoader/Fabric/1.16.x/LMML-1.16.5-2.6.3-Fabric.jar"))
                            )
                    ...
                    e("1.18.2", Map.ofEntries(
                            ...
                            e("4.6.4", JarMetadata.create("https://www.dropbox.com/sh/tzkdz46y67tuohx/AADV9WghyIa-5y8vzulSd_c8a/LittleMaidModelLoader/Fabric/1.18.x/old/LMML-1.18.2-4.6.4-Fabric.jar")),
                            e("4.6.5", JarMetadata.create("https://www.dropbox.com/sh/tzkdz46y67tuohx/AABV5UZqw5eD-XAG9H9WHr7Aa/LittleMaidModelLoader/Fabric/1.18.x/old/LMML-1.18.2-4.6.5-Fabric.jar")),
                            e("4.6.7", JarMetadata.create("https://www.dropbox.com/sh/tzkdz46y67tuohx/AADKato8bCJmU1EvTuaZ8DJSa/LittleMaidModelLoader/Fabric/1.18.x/old/LMML-1.18.2-4.6.7-Fabric.jar")),
                            //latest
                            e("4.6.8", JarMetadata.create("https://www.dropbox.com/sh/tzkdz46y67tuohx/AAClFqk_uFVy8kojel3W89ema/LittleMaidModelLoader/Fabric/1.18.x/LMML-1.18.2-4.6.8-Fabric.jar"))
                            )
                    ),
                    e("1.19", Map.of(
                    ...
                    e("1.19.2", Map.of(
                            ...
                            "5.2.4", JarMetadata.create("https://www.dropbox.com/sh/tzkdz46y67tuohx/AADaJ800jqHdZLoKm8jeNaX4a/LittleMaidModelLoader/Fabric/1.19.2/old/LMML-1.19.2-5.2.4-Fabric.jar"),
                            "5.2.5", JarMetadata.create("https://www.dropbox.com/sh/tzkdz46y67tuohx/AADlBHpdZPSPyDtp_hwMdqXia/LittleMaidModelLoader/Fabric/1.19.2/old/LMML-1.19.2-5.2.5-Fabric.jar"),
                            "5.2.6", JarMetadata.create("https://www.dropbox.com/sh/tzkdz46y67tuohx/AAAQHjIlycweeMfg2b99Bv5Ja/LittleMaidModelLoader/Fabric/1.19.2/old/LMML-1.19.2-5.2.6-Fabric.jar"),
                            "5.2.7", JarMetadata.create("https://www.dropbox.com/sh/tzkdz46y67tuohx/AADRXnXV8icRUrIJWWylcVtBa/LittleMaidModelLoader/Fabric/1.19.2/LMML-1.19.2-5.2.7-Fabric.jar")
                    )),
                    e("1.19.3", Map.of(
                    ...
                    e("1.20", Map.of(
                            ...
                            "8.0.1", JarMetadata.create("https://www.dropbox.com/sh/tzkdz46y67tuohx/AACB2nvdh0wJOBotIC-z6LQea/LittleMaidModelLoader/Fabric/1.20-1.20.1/old/LMML-1.20.1-8.0.1-Fabric.jar"),
                            "8.0.2", JarMetadata.create("https://www.dropbox.com/sh/tzkdz46y67tuohx/AACxjatfjEcBaVYOi3rsgC1Ha/LittleMaidModelLoader/Fabric/1.20-1.20.1/LMML-1.20.1-8.0.2-Fabric.jar")
                            )),
                    e("1.20.1", Map.of(
                            "8.0.0", JarMetadata.create("https://www.dropbox.com/sh/tzkdz46y67tuohx/AABBY2wrG2dgj5NjycT2fSjIa/LittleMaidModelLoader/Fabric/1.20-1.20.1/old/LMML-1.20.1-8.0.0-Fabric.jar"),
                            "8.0.1", JarMetadata.create("https://www.dropbox.com/sh/tzkdz46y67tuohx/AACB2nvdh0wJOBotIC-z6LQea/LittleMaidModelLoader/Fabric/1.20-1.20.1/old/LMML-1.20.1-8.0.1-Fabric.jar"),
                    ...
                    e("1.20.2", Map.of(
                            "9.0.1", JarMetadata.create("https://www.dropbox.com/sh/tzkdz46y67tuohx/AADTVJm8hpzccFsqIeuKm91Oa/LittleMaidModelLoader/Fabric/1.20.2/old/LMML-1.20.2-9.0.1-Fabric.jar"),
                            "9.0.2", JarMetadata.create("https://www.dropbox.com/sh/tzkdz46y67tuohx/AADrfb1wsXOyCNlncIhfeGa2a/LittleMaidModelLoader/Fabric/1.20.2/LMML-1.20.2-9.0.2-Fabric.jar")
                            ))
            );
